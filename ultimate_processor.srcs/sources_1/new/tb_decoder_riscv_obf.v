...
module tb_decoder_riscv_obf();
  ...
  always @(*) begin
    ...
    casez (U8wR)
      ...
      `OP_IMM_OPCODE: begin
        casez ({avHQ, amn5})
          {7'h??, 3'h0}: kQPPGtSqrrg0 = `ADD;
          {7'h00, 3'h1}: kQPPGtSqrrg0 = `SLL;
          {7'h??, 3'h2}: kQPPGtSqrrg0 = `SLT;
          {7'h??, 3'h3}: kQPPGtSqrrg0 = `SLTU;
          {7'h??, 3'h4}: kQPPGtSqrrg0 = `XOR;
          {7'h00, 3'h5}: kQPPGtSqrrg0 = `SRL;
          {7'h20, 3'h5}: kQPPGtSqrrg0 = `SRA;
          {7'h??, 3'h6}: kQPPGtSqrrg0 = `OR;
          {7'h??, 3'h7}: kQPPGtSqrrg0 = `AND;
      ...
      `OP_OPCODE: begin
        case ({avHQ, amn5})
          {7'h00, 3'h0}: kQPPGtSqrrg0 = `ADD;
          {7'h20, 3'h0}: kQPPGtSqrrg0 = `SUB;
          {7'h00, 3'h1}: kQPPGtSqrrg0 = `SLL;
          {7'h00, 3'h2}: kQPPGtSqrrg0 = `SLT;
          {7'h00, 3'h3}: kQPPGtSqrrg0 = `SLTU;
          {7'h00, 3'h4}: kQPPGtSqrrg0 = `XOR;
          {7'h00, 3'h5}: kQPPGtSqrrg0 = `SRL;
          {7'h20, 3'h5}: kQPPGtSqrrg0 = `SRA;
          {7'h00, 3'h6}: kQPPGtSqrrg0 = `OR;
          {7'h00, 3'h7}: kQPPGtSqrrg0 = `AND;
          default: sD7vxFgtY7jG = 1'b1;
        endcase
      ...
      `BRANCH_OPCODE: begin
        case (amn5)
          3'h0: kQPPGtSqrrg0 = `BEQ;
          3'h1: kQPPGtSqrrg0 = `BNE;
          3'h4: kQPPGtSqrrg0 = `BLT;
          3'h5: kQPPGtSqrrg0 = `BGE;
          3'h6: kQPPGtSqrrg0 = `BLTU;
          3'h7: kQPPGtSqrrg0 = `BGEU;
          default: sD7vxFgtY7jG = 1'b1;
        endcase
      end
  ...
  always begin
    ...
    if ((VFNI1TeJWM5X != `ADD)  & (VFNI1TeJWM5X != `SUB) &
        (VFNI1TeJWM5X != `XOR)  & (VFNI1TeJWM5X != `OR)  &
        (VFNI1TeJWM5X != `AND)  & (VFNI1TeJWM5X != `SRA) &
        (VFNI1TeJWM5X != `SRL)  & (VFNI1TeJWM5X != `SLL) &
        (VFNI1TeJWM5X != `BLT)  & (VFNI1TeJWM5X != `BLTU) &
        (VFNI1TeJWM5X != `BGE)  & (VFNI1TeJWM5X != `BGEU) &
        (VFNI1TeJWM5X != `BEQ)   & (VFNI1TeJWM5X != `BNE)  &
        (VFNI1TeJWM5X != `SLT) & (VFNI1TeJWM5X != `SLTU)) begin
